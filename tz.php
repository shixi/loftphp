...
date_default_timezone_set('PRC');//GMT+8 中国时区
...
<title>PHP探针 - 冰梦  - 增强版 <?php echo $version; ?></title>
<style type="text/css">
<!--
...
{
	document.getElementById("loading1").className += " hide";
...
<body>
<span class="loading1" id="loading1" >加载中......</span>
<?php 
ob_flush();
flush();
...
<div id="page">
    <div id="header">
        <h1>PHP探针 - 冰梦  - 增强版 <?php echo $version; ?></h1>
    </div>
...
?>
          物理内存：共
          <font color='#CC0000'><?php echo round($sysInfo['memTotal']/1024,3)?></font>
          G , 已用
          ...
          <div class="bar"><div id="barmemPercent" class="barli" style="width:0;">&nbsp;</div> </div>
          Cache化内存为
          <span id="CachedMemory">0</span>
          G, 真实内存使用率为
          <span id="memRealPercent">0</span>
          %
          <div class="bar"><div id="barmemRealPercent" class="barli" style="width:0;">&nbsp;</div></div>
          SWAP区：共
          <?php echo round($sysInfo['swapTotal']/1024,2)?>
          G, 已使用
          ...
          %
          <div class="bar"><div id="barswapPercent" class="barli" style="width:0;">&nbsp;</div> </div>
	  </td>
	</tr>
</table>
<?php }?>
